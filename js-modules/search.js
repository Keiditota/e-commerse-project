...
export function searchResults(){
    ...
    searchBar.addEventListener('input',(e)=>{
        ...
        <p><a class='search-suggestions' href="/htmls/product.html?id=${product.id}" ><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="14" height="14" viewBox="0 0 50 50">
